...
@section('content')
    <a href="{{ route('admin.tags.create') }}" class="btn btn-primary">Crear un nuevo tag</a>
    <!-- BUSCADOR DE TAGS -->
        ...
        @foreach($tags as $tag)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('admin.tags.show', $tag->id) }}" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
