...
@section('content')
    <a href="{{ route('admin.categories.create') }}" class="btn btn-primary">Crear una nueva categoria</a> <br><br>
        ...
        @foreach($categories as $category)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('admin.categories.show', $category->id) }}" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
