...
@section('content')
    <a href="{{ route('admin.articles.create') }}" class="btn btn-primary">Crear una nuevo articulo</a>
        ...
        @foreach($articles as $article)
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('admin.articles.show', $article->id) }}" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
